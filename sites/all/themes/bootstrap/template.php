...
function bootstrap_bootstrap_search_form_wrapper(&$variables) {
 ...
 function bootstrap_preprocess_field(&$variables, $hook) {
	unset($variables['classes_array'][2]);
	unset($variables['classes_array'][3]);
	
  if ($variables['element']['#field_name'] == "field_tab_title" && $variables['element']['#entity_type'] == "field_collection_item") {
	 $variables['theme_hook_suggestions'][] = 'field__field_tab_title__field_tabs_bs';
	 //dpm($variables);
  }
 }
